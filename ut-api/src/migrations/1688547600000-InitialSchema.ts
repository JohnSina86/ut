...
export class InitialSchema1688547600000 implements MigrationInterface {
    name = 'InitialSchema1688547600000'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        CREATE TABLE \`vehicle_lookup_cache\` (
          ...
          KEY \`idx_looked_up_at\` (\`looked_up_at\`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
        `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE \`vehicle_lookup_cache\`;`);
        await queryRunner.query(`DROP TABLE \`business_settings\`;`);
        await queryRunner.query(`DROP TABLE \`transactions\`;`);
        await queryRunner.query(`DROP TABLE \`appointments\`;`);
        await queryRunner.query(`DROP TABLE \`services\`;`);
        await queryRunner.query(`DROP TABLE \`vehicle_specs\`;`);
